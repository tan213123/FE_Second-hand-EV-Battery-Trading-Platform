        ...
        <div className="content-wrapper">
          ...
          <aside className="sidebar">
              ...
              <div className="filter-section">
                ...
                <div className="filter-options">
                  {(showAllBatteryTypes ? batteryTypes : batteryTypes.slice(0, 3)).map((type, index) => (
                    <label key={index} className="filter-option">
                      <input type="checkbox" />
                      <span>{type}</span>
                    </label>
            ...
            <div className="listings-section">
              ...
              <div className="listings-grid">
                {batteryListings.map((battery) => (
                  <div key={battery.id} className="battery-card">
                    ...
                    {battery.featured && <div className="featured-badge">Tin tiêu biểu</div>}
                    ...
                    <div className="battery-content">
                      ...
                      <div className="battery-specs">
                        ...
                        {battery.health && <span>Sức khỏe: {battery.health}</span>}
                      </div>
              ...
              <div className="price-range-banner">
                ...
                <span className="banner-text">Bạn tìm pin xe điện trong khoảng giá nào?</span>
                <span className="banner-icon">⚡</span>
              </div>
              ...
              <div className="brand-selection-section">
                <h2 className="section-title">Bạn cần tìm thương hiệu pin nào?</h2>
